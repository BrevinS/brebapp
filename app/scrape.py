...
def props_today():
    ...
    stat_list = datasets[-1]
    stat_whitelist = ['name', 'team', 'opp', 'draftkings_pts', 'draftkings_reb', 'draftkings_ast', 'draftkings_threes']
    # make stat whitelist into a list of dictionaries
...
def get_season_start_end_datetimes_helper(url):
    ...
    # UPDATED TO RETURN DATES
    return parser.parse(scoreboard['page']['content']['scoreboard']['season']['startDate']), parser.parse(scoreboard['page']['content']['scoreboard']['season']['endDate'])
